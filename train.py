...
flags.DEFINE_string("train_file",   os.path.join("data", "example_predict.txt"),  "Path for train data")
flags.DEFINE_string("dev_file",     os.path.join("data", "example_dev.txt"),    "Path for dev data")
flags.DEFINE_string("test_file",    os.path.join("data", "example_test.txt"),   "Path for test data")
flags.DEFINE_string("predict_file", os.path.join("data", "example_predict.txt"), "Path for predict data")
...
def main(_):
    ...
    print('run time: %s minutes' % (end/60 - start/60))
